...
# GAS=128
EXPERIMENTS = {
    8: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_128_MBS2_NN2_weak_scaling.log",
    16: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_256_MBS2_NN4_weak_scaling.log",
    32: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_512_MBS2_NN8_weak_scaling.log",
    64: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_1024_MBS2_NN16_weak_scaling.log",
    128: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_2048_MBS2_NN32_weak_scaling.log",
    256: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_4096_MBS2_NN64_weak_scaling.log",
    512: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_8192_MBS2_NN128_weak_scaling.log",
    1024: "logs/JUPITER_qwen3-30B-A2B_TP1_PP2_VPP_1_EP4_GBS_16384_MBS2_NN256_weak_scaling.log",
}

# Output filename for the combined figure (None = show interactively).
OUTPUT_FILE = "qwen3_30B-A22B_jupiter_weak_scaling.png"

# Title for the top (token throughput) bar chart.
PLOT_TITLE = "Token Throughput Megatron Qwen 3 30B A3B (TP 1, PP 2, EP 4, VP 1, GAS 64, MBS 2)"
...
def main():
    ...
    }).to_csv("MoE-30B-weak-scaling.csv", index=False)
